...
extern "C" {
	...
	const uint8_t start_adress_chip_on = 25; // включительно
	const uint8_t end_adress_chip_on = 10; // включительно (если < start_adress_chip_on, то выключено) // TODO проверить этот момент..
	const uint8_t start_adress_chip_off = 18; // включительно
	const uint8_t end_adress_chip_off = 20; // включительно всего 23
