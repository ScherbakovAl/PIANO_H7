...
typedef struct _objects_t {
    ...
    lv_obj_t *test_t_out;
    lv_obj_t *test_speed;
    lv_obj_t *test_midi_hi;
    lv_obj_t *test_midi_lo;
    lv_obj_t *test_t_out_;
    lv_obj_t *test_speed_;
    lv_obj_t *test_midi_hi_;
    lv_obj_t *test_midi_lo_;
    lv_obj_t *test_energy;
    lv_obj_t *test_energy_;
    lv_obj_t *tick;
    lv_obj_t *int_t;
    lv_obj_t *float_t;
